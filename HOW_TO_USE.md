...
| :--- | :---: | :--- | :---: | :---: | :--- |
| **`SCALP`** | **5m** (Mikro) | Rejection Block, 4H-Range Re-entry, Inverse FVG (IFVG), Liquidity Sweep, VWAP $\pm 2\sigma$, Volume Surge | **0.35% – 0.50%** (Micro-Kelly) | **1:1.50 – 1:2.50** | Eksekusi cepat, durasi 15–35 menit, Micro-BE (+0.60R), Time-Stop 20 menit |
